...
import PROGRESS_TITLE from 'page/StoreRegistration/constant/progress';
      ...
      <div className={styles.content}>
        ...
        <div className={styles.block}>
          ...
          <div className={styles.block__text}>
            ...
            <button type="button" className={styles.block__button} onClick={() => setStep(step + 1)}>가게 정보 기입</button>
          </div>
        </div>
        )}
        {step === 1 && (
