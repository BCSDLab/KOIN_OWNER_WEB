...
interface CatagoryMenuProps {
  name: string;
  menus: Menu[];
}
export default function CatagoryMenuList({ menus, name }: CatagoryMenuProps) {
  return (
    <div className={styles['category-menu-list']}>
      <div className={styles['category__title-wrapper']}>
        <div className={styles.category__title}>
          {name}
          {name === '이벤트 메뉴' ? (
            <EventMarkIcon className={styles['category__event-menu-icon--mark']} />) : null}
        </div>
      </div>
